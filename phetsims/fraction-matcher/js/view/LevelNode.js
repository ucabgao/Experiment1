...
define(function (require) {
    ...
    function LevelNode(model, levelsContainer, layoutBounds, stepSource, options) {
        ...
        var buttonCheck = new TextPushButton(buttonCheckString, _.extend(commonButtonStyle, {
            baseColor: '#FFD63F',
            listener: function () { model.answerButton('check'); }
        }));
        thisNode.addChild(buttonCheck);
        var buttonOk = new TextPushButton(buttonOkString, _.extend(commonButtonStyle, {
            baseColor: '#44FF44',
            listener: function () {
        ...
        var buttonTryAgain = new TextPushButton(buttonTryAgainString, _.extend(commonButtonStyle, {
            baseColor: '#FF7C3B',
            listener: function () {
        ...
        var buttonShowAnswer = new TextPushButton(buttonShowAnswerString, _.extend(commonButtonStyle, {
            baseColor: '#FF7C3B',
            listener: function () {
            ...
            if (this.model.answers.length === this.model.gameModel.MAXIMUM_PAIRS * 2 || debugRewards) {
                ...
                this.levelCompletedNodeContainer = new Node({
                    children: [
                        ...
                        new LevelCompletedNode(this.model.levelNumber - 1, this.model.score, 12, 3, this.model.gameModel.isTimer, completedTime, lastBestForThisLevel, newBestTime, function () {
